...
namespace modui::ui
{
	...
	void MemoryText::render()
	{
		...
		draw_list->AddText(ImGui::GetFont(), this->_font_size, text_pos, this->is_on_card() ? theme(ThemeColor::OnSurfaceVariant) : theme(ThemeColor::OnSurface), this->_text, nullptr, this->_calculated_size.x);
	}
